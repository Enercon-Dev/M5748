...
{
    public class M1787Frame : BasicFrame
    {
        protected override int HeaderLength { get { return 5; } }
        ...
        //copy constructor
        public M1787Frame(M1787Frame frame)
        {
        ...
        {
            return new M1787Frame(this);
        }

        
        //private static byte[] commandMagicNumber = { 0xA1, 0xB2, 0xC3, 0xD4 };
        //private static byte[] telemMagicNumber = { 0xA1, 0xB2, 0xC3, 0xD4 };
