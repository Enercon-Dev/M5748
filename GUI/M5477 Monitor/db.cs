    ...
    public partial class MainForm : Form
    {
        private void dbInit()
        {
           ...
           // db.AddField(new DBAnalogField("AnIn.Spare1", "", new AnalogDecoder(16, 1, 0), ""));
            ...
            //{
            //    string s = "[" + b.ToString() + "]";
            //    db.AddField(new DBFlagField("HPF.CurrentLimitH" + s, "", flagDecoder));
            //    db.AddField(new DBFlagField("HPF.CurrentLimitL" + s, "", flagDecoder));
            //    db.AddField(new DBFlagField("HPF.ZerroCross" + s, "", flagDecoder));
            //    db.AddField(new DBFlagField("HPF.Comp" + s, "", flagDecoder));
            //}

            //db.AddField(new DBFlagField("HPF.HPFSync", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.InrushEnded", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.Uvcc_aux", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.BusHOV", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.BusLOV", "", flagDecoder));

            //db.AddField(new DBAnalogField("HPF.AnIn.PH_A", "", new AnalogDecoder(16, 0.950, -486.5), "V"));
            //db.AddField(new DBAnalogField("HPF.AnIn.PH_B", "", new AnalogDecoder(16, 0.950, -486.5), "V"));
            //db.AddField(new DBAnalogField("HPF.AnIn.PH_C", "", new AnalogDecoder(16, 0.950, -486.5), "V"));
            //db.AddField(new DBAnalogField("HPF.AnIn.BUS_P", "", new AnalogDecoder(16, 0.537, 0), "V"));
            //db.AddField(new DBAnalogField("HPF.AnIn.BUS_N", "", new AnalogDecoder(16, -0.537, 0), "V"));
            //db.AddField(new DBAnalogField("HPF.AnIn.Temp", "", new TempDecoder(16, 1.0 / 1024, 0, 4990), "°"));
            //db.AddField(new DBAnalogField("HPF.AnIn.vcc3_3", "", new AnalogDecoder(16, 0.00488, 0), "V"));

            //db.AddField(new DBAnalogField("HPF.VinRect", "", new AnalogDecoder(16, 0.9766, 0), "V"));
            //db.AddField(new DBAnalogField("HPF.ErrorAmp", "", new AnalogDecoder(16, 1.0 / 4096 * 100, 0), "%"));
            //db.AddField(new DBAnalogField("HPF.BalancerErrorAmp", "", new AnalogDecoder(16, 1.0 / 1024 * 200, -100), "%"));

            //db.AddField(new DBFlagField("HPF.InrushEN", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.ConvertersEnable", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.LoadEnable", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.PhaseLoss", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.InOk", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.DelayedInOk", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.OVLock", "", flagDecoder));
            //db.AddField(new DBFlagField("HPF.SyncPresent", "", flagDecoder));
            //db.AddField(new DBRawIntField("HPF.SHDNReason", "", new RawIntDecoder(8)));

            //M5477 - Isolator
            db.AddField(new DBRawIntField("ISO.Version.Major", "", new RawIntDecoder(4)));
            db.AddField(new DBRawIntField("ISO.Version.Minor", "", new RawIntDecoder(4)));

            db.AddField(new DBFlagField("ISO.UVCC_High", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.HPF_Ready", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.OV", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.CurrentFault", "", flagDecoder));

            db.AddField(new DBAnalogField("ISO.AnIn.Viso", "", new AnalogDecoder(16, 525.0 / 1024, 0), "V"));
            db.AddField(new DBAnalogField("ISO.AnIn.Iprimary", "", new AnalogDecoder(16, 1, 0), "A"));
            db.AddField(new DBAnalogField("ISO.AnIn.Temp1", "", new TempDecoder(16, 1.0 / 1024, 0, 4990), "°"));
            db.AddField(new DBAnalogField("ISO.AnIn.Temp2", "", new TempDecoder(16, 1.0 / 1024, 0, 4990), "°"));
            db.AddField(new DBAnalogField("ISO.AnIn.Iprimary2", "", new AnalogDecoder(16, 1, 0), "A"));

            db.AddField(new DBFlagField("ISO.ISO_Ready", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.ISO_Enable", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.CurrentFaultLock", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.OVLock", "", flagDecoder));
            db.AddField(new DBFlagField("ISO.WakeUpTimeOut", "", flagDecoder));
            db.AddField(new DBRawIntField("ISO.SHDNReason", "", new RawIntDecoder(8)));

            //M5477 - BUCK:
            db.AddField(new DBRawIntField("BUCK.Version.Major", "", new RawIntDecoder(4)));
            db.AddField(new DBRawIntField("BUCK.Version.Minor", "", new RawIntDecoder(4)));
            db.AddField(new DBFlagField("BUCK.CurrentFault", "", flagDecoder));
            db.AddField(new DBFlagField("BUCK.UVCC_AUX", "", flagDecoder));
            db.AddField(new DBFlagField("BUCK.rowISO_Ready", "", flagDecoder));
            db.AddField(new DBFlagField("BUCK.Comp2", "", flagDecoder));
            db.AddField(new DBFlagField("BUCK.Comp1", "", flagDecoder));

            db.AddField(new DBFlagField("BUCK.ISO_Ready", "", flagDecoder));
            db.AddField(new DBFlagField("BUCK.EnableCMD", "", flagDecoder));
            db.AddField(new DBAnalogField("BUCK.VoutCMD", "", new AnalogDecoder(16, 0.1668, 0), "V"));
            db.AddField(new DBAnalogField("BUCK.IoutCMD", "", new AnalogDecoder(16, 5.0 / 1024 / 0.09, 0), "A")); //90mV/A
            db.AddField(new DBAnalogField("BUCK.OverVoltageCMD", "", new AnalogDecoder(16, 0.447, 0), "V"));
            db.AddField(new DBAnalogField("BUCK.OverCurrentCMD", "", new AnalogDecoder(16, 0.0339, -4.167), "A"));

            db.AddField(new DBAnalogField("BUCK.AnIn.Vin", "", new AnalogDecoder(16, 0.6116, 0), "V"));
            db.AddField(new DBAnalogField("BUCK.AnIn.Iout", "", new AnalogDecoder(16, 2.5 / 1024 / 0.072 / 4, -4.167), "A"));
            db.AddField(new DBAnalogField("BUCK.AnIn.Temp", "", new TempDecoder(16, 1.0 / 1024, 0, 4990), "°"));
            db.AddField(new DBAnalogField("BUCK.AnIn.PTCTemp", "", new TempDecoder(16, 1.0 / 1024, 0, 4990), "°"));
            db.AddField(new DBAnalogField("BUCK.AnIn.vcc3_3", "", new AnalogDecoder(16, 0.00488, 0), "V"));
            db.AddField(new DBAnalogField("BUCK.AnIn.Vout", "", new AnalogDecoder(16, 0.447 / 4, 0), "V"));
