...
namespace M5748SWUpdater
{
    class SerialComm
    {
        ...
        protected IFrame basicFrame = new M1787Frame();
...
#warning is 1Sec enaugh
        ...
        {
            M1787Frame outFrame = ConstructFrame(buffer, description, ID);

            M1787Frame recivedFrame = SendAndReceive(outFrame);
        ...
        private M1787Frame SendAndReceive(M1787Frame outFrame)
        {
            try
            {
                for (int retries = 0; retries < MaxRetries; retries++)
                {
                    ...
                    M1787Frame recivedFrame = (M1787Frame)ReceiveFrame();
                    ...
                    if (recivedFrame != null && recivedFrame.GetDataBuffer()[0] == 0x80) //0x80 is a temp number
                    {
        ...
        private M1787Frame ConstructFrame(DataBuffer buffer, string description, bool ID)
        {
            ...
            M1787Frame frame = new M1787Frame(newBuffer.GetDataBuffer());
