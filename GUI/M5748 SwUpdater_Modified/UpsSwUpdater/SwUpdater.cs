...
namespace M5748SWUpdater
{
    class SwUpdater
    {
        ...
        SerialComm comm;
        private const string FirmewareVersion = "v1.01";
        private const string FirmewareVersionString = "M5748Batt " + FirmewareVersion;
        ...
        private byte[] MainProgFile = M5748SwUpdater.Properties.Resources.Ver_0_45;
#warning Do not forget to change the "FirmewareVersion" and "LoaderVersionString" strings !!!
        ...
        public void Run()
        {
            ...
            try
            {
                Console.WriteLine("This program is about to update the firmware of M5748Batt to " + FirmewareVersion);
