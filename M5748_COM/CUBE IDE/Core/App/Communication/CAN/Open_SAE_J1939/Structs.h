...
#define MAX_PROPRIETARY_A 100
//if MAX_PROPRIETARY_A is changed then FRAME_MAX_DATA_SIZE should be changed as well
#endif
...
#define PGN_ALPS_STATUS1         0xFFA0
#define PGN_ALPS_ANALOG_STATUS  0xFFA1
#endif
...
struct TP_CM {
	...
	uint8_t max_number_of_packages_to_send;
	/* CTS */
