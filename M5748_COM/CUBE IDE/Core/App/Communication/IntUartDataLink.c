...
void intUart_LineIsFree(uint32_t ch)
{
  //this function is used by higher level functions to indicate that currently the line is free,
  // it usually happend when a telemetry request received and 
  SetDebounce(&sLineFree[ch], TRUE);
}
