...
void readAnalogInputs() // read all IN
{
    ...
    if((rowAnIn.test_Ref * 3300 / 4096) < 2.0f) // error in vref,TODO: move to self test function
    {
...
// for NTCLE413E2103F106A Termistor
const LinearSegment temp15_table[] = {{156,3931},{192,3841},{243,3741},{311,3641},{399,3541},{503,3451},{618,3371},{781,3281},{984,3191},{1264,3091},{1638,2981},{2993,2641},{3387,2521},{3635,2421},{3797,2331}};
#define TEMP15_TABLE_SIZE 15
