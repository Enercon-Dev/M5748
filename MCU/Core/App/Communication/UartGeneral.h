...
#define FRAME_MIN_SIZE (FRAME_EMPTY_SIZE + FRAME_MIN_DATA_SIZE)     //6+1=7
#define FRAME_MAX_SIZE (FRAME_EMPTY_SIZE + FRAME_MAX_DATA_SIZE)     //7+100=108
