...
typedef enum {
  IAP_DISABLED, IAP_IDLE, IAP_RECEIVING, IAP_RECEIVED_OK, IAP_RECEIVED_CRC_ERROR, IAP_RECEIVED_LENGTH_ERROR, IAP_ERROR
} iap_status_t;

extern int bIAP_enabled;
extern iap_status_t IAP_status;
